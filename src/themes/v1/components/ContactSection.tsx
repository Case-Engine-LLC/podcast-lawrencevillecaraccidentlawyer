...
const ContactSection = () => {
  const firmHost = contact.website.replace(/^https?:\/\//, '').split('/')[0]
  const firmContactUrl = `https://${firmHost}/contact-us/`
        ...
        <div className="bg-white rounded-[12px] shadow-sm overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="md:w-2/3 p-12 flex flex-col justify-center">
            ...
            <p className="text-[16px] text-black/70 mb-8 max-w-lg">
              Talk directly with the {firmHost.replace(/^www\./, '')} team about your case. Free consultation, no obligation — your case stays with the firm, not the podcast.
            </p>
